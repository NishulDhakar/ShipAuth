            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <p className="mb-8 max-w-xl mx-auto dark:text-white/80 relative z-10">
                         ...
                         <a href="https://github.com/NishulDhakar/shipauth" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-4 py-2 text-center sm:w-auto bg-white dark:bg-zinc-900 text-primary border border-gray-200 dark:border-zinc-800 px-8 py-3.5 rounded-xl text-base font-medium hover:bg-gray-50 dark:hover:bg-zinc-800 transition-all shadow-sm hover:shadow-md flex items-center justify-center gap-2">
